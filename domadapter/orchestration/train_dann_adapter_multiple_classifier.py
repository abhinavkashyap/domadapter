...
from domadapter.models.adapters.dann_adapter_multiple_classifier import DANNAdapter
...
def train_dann(
    ...
    checkpoints_dir = exp_dir.joinpath("dann_adapter_multiple_classifier", exp_name)
