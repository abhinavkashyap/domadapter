...
from domadapter.models.adapters.dsn_adapter import DSNAdapter
...
def train_dsn(
    ...
    exp_dir = exp_dir.joinpath(source_target, "dsn_adapter")
    ...
    if data_module == "mnli":
        ...
        project_name = f"MNLI_{pretrained_model_name} ACL"
    elif data_module == "sa":
        dm = SADataModuleSourceTarget(hyperparams)
        project_name = f"SA_{pretrained_model_name} ACL"

    dm.prepare_data()

    model = DSNAdapter(hyperparams)
